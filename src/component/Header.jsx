    ...
    <>
      <div className="container-1">
          ...
          <div className="navbar">
            <nav>
              <div className="sidemenu">
                ...
                <div className="close-icon" onClick={openMenu}>
                  {menuClick ? (
                    <IoClose size={23} />
                  ) : (
              ...
              <ul className={`navlist ${menuClick ? "open" : ""}`}>
                ...
                <li>
                  <Link to="/promotion">
                    PROMOTION <FaAngleDown size={12} />
                  </Link>{" "}
                </li>
                <li>
                  <Link to="/blog">
                    BLOGS <FaAngleDown size={12} />
                  </Link>{" "}
                </li>
                <li>
                  <Link to="/page">
        ...
        <div className="hero">
          ...
          <div className="slide">
            <div className="container-fluid cont-slide">
              <div
              ...
              >
                ...
                <div className="carousel-inner">
                  <div
                    className="carousel-item pix1 active"
                  ...
                  >
                    ...
                    <div className="carousel-text">
                      ...
                      <h5>Only from $94</h5>
                      <p>
                        dipiscing elit tempus natoque faucibus viverra, litora
                        odio vitae cras blandit ut est integer nisl in ac
                      </p>
          ...
          <div className="hero-gallery">
            <div className="smallhero">
              <div className="hero-text">
                <div className="boldtext">SAMSUNG TAB</div>
                <h2>TABLET</h2>
            ...
            <div className="smallhero">
              <div className="hero-text">
                <div className="boldtext">BEAT BAND</div>
                <h2>HEADPHONE</h2>
